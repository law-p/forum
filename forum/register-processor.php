...
if (isset($_POST['sent'])) {
    ...
    $about = mysqli_real_escape_string($connection, $_POST['ABOUT_ME']);
    ...
    if ($password !== $confirmPassword) {
        ...
        $duplicateCheckQuery = "SELECT * FROM `admin` WHERE EMAIL='$email'";
        ...
        if (mysqli_num_rows($duplicateCheckResult) > 0) {
            ...
            $query = "INSERT INTO `admin` (FNAME, LNAME, EMAIL, ABOUT_ME, PHONE, WEBSITE, SKILLS, PASSWORD) VALUES ('$fname', '$lname', '$email', '$about', '$phone', '$website', '$skills',  '$hashedPassword')";
